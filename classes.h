...
enum parameters {ELEMENT_LENGTH, CONST_TAU, CONST_KAPPA, CONST_LAMBDA, CONST_IPSILON,
CONST_ALPHA, CONST_DELTA, CONST_PSI, CONST_ETA};
...
class mesh{
    ...
    public:
        ...
        float delta, float eta) {
            ...
            parameters[CONST_LAMBDA]= lambda;
            parameters[CONST_IPSILON]= ipsilon;
            parameters[CONST_ALPHA]= alpha;
            parameters[CONST_DELTA]= delta;
            parameters[CONST_PSI]= psi;
            parameters[CONST_ETA]= eta;
        }
